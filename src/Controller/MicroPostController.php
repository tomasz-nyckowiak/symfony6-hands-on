...
class MicroPostController extends AbstractController
{
    ...
    {        
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            //1. Add a flash method - message being displayed to the person that submitted the form was successful
            //2. And then this message disappears on further requests
            $this->addFlash('success', 'Your micro post have been added');

            return $this->redirectToRoute('app_micro_post');
            //3. Redirect to some different page
